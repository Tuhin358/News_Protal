            ...
            @endif  --}}
                <div class="row">
                    <form action="{{route('subdistrict.store') }}" method="post" >
                        {{--  {{route('subdistrict.store') }}  --}}
                    @csrf

                    <div class="form-group">
                        <label for="exampleInputEmail1">Subdistrict Name English</label>
                        <input type="text" class="form-control" id="english" aria-describedby="emailHelp" name="subdistrict_en" placeholder="Enter English Name" required="" >

                    </div>

                    <div class="form-group">
                        <label for="exampleInputEmail1">Subdistrict Name Bangla</label>
                        <input type="text" class="form-control" id="bangla" aria-describedby="emailHelp" name="subdistrict_bn" placeholder="Enter Bangla Name" required="" >
